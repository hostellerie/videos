...
$cacheLabels = array('search' => 'Résultats de recherche', 'videos' => 'Informations des vidéos', 'channels' => 'Informations des chaînes', 'availability' => 'Vérifications de disponibilité');
...
echo COM_createHTMLDocument($html, array('pagetitle' => 'Videos — Statistiques', 'headercode' => VIDEOS_adminHeaderCode()));
